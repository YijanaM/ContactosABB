...
public class ArbolBinario {
    ...
    public Nodo buscarContacto(String parteDelNombre) {
        return buscarContacto(raiz, parteDelNombre.toUpperCase());
    }

    private Nodo buscarContacto(Nodo n, String parteDelNombre) {
        if (n == null) {
            return null;
        }

        String nombreEnNodo = n.nombre.toUpperCase();
        if (nombreEnNodo.startsWith(parteDelNombre)) {
            return n;
        } else if (parteDelNombre.compareTo(nombreEnNodo) < 0) {
            return buscarContacto(n.izquierdo, parteDelNombre);
        } else {
            return buscarContacto(n.derecho, parteDelNombre);
        }
    }
